    ...
    const content = (
      <>
        <img
          ...
          src="images/netflix-image.png"
          alt="Netflix App"
        />
        <h5 className="text-description">
          Netflix Clone: an immersive, web-based streaming experience crafted
          meticulously using React. This application replicates the core
          features of the original Netflix, enabling users to explore a vast
          array of movies and TV shows with ease.
        </h5>
        ...
        <a
          ...
          onClick={() =>
            window.open(
              "https://netflix-clone-krishna-kalluri-5rqge6hwu-krishna-kalluri.vercel.app/browse"
            )
          }
        >
          https://netflix-clone-krishna-kalluri-5rqge6hwu-krishna-kalluri.vercel.app/browse
        ...
        <a
          className="hyper-link"
          onClick={() =>
            window.open("https://github.com/surendra1151/Netflix-Clone")
          }
        >
          https://github.com/surendra1151/Netflix-Clone
        </a>
      </>
    );
