          ...
          <div id="experience" className="page two">
            ...
            <div className="resume-wrap d-flex">
              ...
              <div className="text pl-3 experience">
                ...
                <span className="position">Cove.tool</span>
                <p className="date">Mar 2022 - Present</p>
                <ul>
                  <li>
                    Responsible for redesigning Cove tool dashboard with new
                    user interface and more user friendly.
                  </li>
                  <li>
                    Responsible for adding new features to the load modeling
                    tool, which aids in the calculation of energy generated by
                    the building.
                  </li>
                  <li>
                    Chat functionality was implemented for consumer interactions
                    with the sales staff.
                  </li>
                  <li>
                    Developing Rest APIs using python to retrieve huge data from
                    databases, upload compressed files to S3 buckets, and
                    deliver the data to a front end to display.
                  </li>
                  <li>
                    Involved in bug fixing for new features in both frontend and
                    backend.
                  </li>
                </ul>
              </div>
            ...
            <div className="resume-wrap d-flex">
              ...
              <div className="text pl-3 experience">
                ...
                <span className="position">John Deere</span>
                <p className="date">Oct 2021 - March 2022</p>
                <ul>
                  <li>
                    Responsible for Development of single page application using
                    React.js with Redux, Node.js, Express and LESS.
                  </li>
                  <li>
                    Successfully translate business requirements into
                    technological specifications ensures that the final product
                    is both functional and efficient, and meets the unique needs
                    of the client.
                  </li>
                  <li>
                    Expertise in capturing user events and rendering the
                    appropriate action and dynamically rendering the UI based on
                    user actions using React.js.
                  </li>
                  <li>
                    Experience in using Jest and React Testing library for
            ...
            <div className="resume-wrap d-flex">
              ...
              <div className="text pl-3 experience">
                ...
                <ul>
                  <li>
                    Design, develop, and test a website that fulfills
                    accessibility and web browser standards using HTML5, CSS3,
                    Bootstrap, JavaScript, jQuery, and React.JS, Node, Express.
                  </li>
                  <li>
                  ...
                  <li>
                    worked on the bug-fixing team to fix significant bugs in
                    ReactJS, Node, and MongoDB for report generation
                  </li>
                  <li>
                    Involved in all the stages of Software Development Life
                    Cycle like Application Design, Development, Debugging and
